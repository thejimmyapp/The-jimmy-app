...
`main` = `213d0b21bf3ca7e075b3624c6cb9b73e3d16f83a` (M22). Merge chain after M9 `a430267`: M10 `24a10ce` LEDGER-8 · M11 `e490001` PARITY-05b · M12 `f9b3e39` PARITY-05c · M13 `74a7d69` PARITY-05d · M14 `8a25ad4` PARITY-06a · M15 `ddb4417` PARITY-06b rulings · M16 `ac75e42` PARITY-06c · M17 `f9573de` PARITY-06d + PARITY-06b-ADD2 · M18 `fb391e3` USAB-01 · M19 `2bf4adb` USAB-02 · M20 `ca3d4d6` USAB-03 · M21 `b744e2c` LEDGER-9 · M22 `213d0b2` USAB-E2E. Golden at M22 (gate, merged tree; bundle unchanged since M20): vitest 70 files / 323 tests, eslint clean, pytest 204 (backend unchanged since M3); production serves `index-Bfz8bXse.js` + `index-DbVLPTEY.css` (verified 2026-09-09 21:29Z). Offline regression: `cd frontend && pnpm usability:journey` (Python 3.11 venv with requirements.txt, Chrome or `PLAYWRIGHT_EXECUTABLE_PATH`) — real local FastAPI with fixture matchups, strict pointer Playwright, four journeys (default/Study × 1440×900/1024×768) each 3 saves → 3/3; gate-run PASS 2026-09-09 22:01Z.
