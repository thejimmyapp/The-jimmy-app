...
describe("incomplete partner-board state", () => {
  afterEach(cleanup);
  beforeEach(() => {
  ...
  it("states the missing data plainly and offers safe recovery actions", () => {
    ...
    expect(screen.getByText("Partner board was not included in the available Chess.com data.")).toBeTruthy();
    ...
    expect(screen.getByText("Continuing with Board A only.")).toBeTruthy();
