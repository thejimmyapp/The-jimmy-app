export const buildChessComConnectorPrompt = (appUrl: string): string => {
...
6. In The Jimmy App, open "Connect Chess.com" and use the Chess.com username already entered by the current user. Expand "Load complete two-board data", paste the cURL into the private connector field, and click "Load both boards".
