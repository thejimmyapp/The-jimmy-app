...
def main() -> None:
    build_pdf(
        source=REPORTS / "thejimmyapp_improvement_guide.md",
        output=REPORTS / "thejimmyapp_what_this_app_can_do.pdf",
        subtitle="What This App Can Do and How to Use It to Improve",
    )
    build_pdf(
        source=REPORTS / "INSTALLATION_AND_ENRICHMENT_GUIDE.md",
        output=REPORTS / "thejimmyapp_installation_and_enrichment_guide.pdf",
...
def cover_page(title: str, subtitle: str, styles: dict[str, ParagraphStyle]) -> list:
    data = [
        ...
        [
            Paragraph(
                "Collaborative Bughouse Coach for importing Bughouse games, reviewing two-board positions, "
